...
public class VtnTblResultado extends JInternalFrame implements ActionListener {
	private GestionCompetencia gc;
	private JTable tblResultado;

	public VtnTblResultado(GestionCompetencia gc) {

	

		this.gc = gc;
		
		setTitle("Tabla Resultado");
		setClosable(true);
		...
		JLabel lblTitulo = new JLabel("Datos del Resultado");
		pnlTitulo.add(lblTitulo);

		tblResultado = new JTable();
		tblResultado.setModel(new ModelResultado());

		JScrollPane scrollPaneTabla = new JScrollPane(tblResultado);
	...
	public void cargarDatos() {
		tblResultado.setModel(new ModelResultado(gc.getResultados()));
	}
