...
public class VtnTblCompetencia extends JInternalFrame implements ActionListener {
	private GestionCompetencia gc;
	private JTable tblCompetencia;

	public VtnTblCompetencia(GestionCompetencia gc) {

	

		this.gc = gc;
		
		setTitle("Tabla Competencia");
		setClosable(true);
		...
		tblCompetencia.setModel(new ModelCompetencia());

		JScrollPane scrollPaneTabla = new JScrollPane(tblCompetencia);
	...
	public void cargarDatos() {
		tblCompetencia.setModel(new ModelCompetencia(gc.getCompetencias()));
	}
