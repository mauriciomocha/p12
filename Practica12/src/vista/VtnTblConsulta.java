...
public class VtnTblConsulta extends JInternalFrame implements ActionListener {

	private GestionPaciente gp;
	private JTable tblConsulta;

	public VtnTblConsulta(GestionPaciente gp) {

	

		this.gp = gp;
		
		setTitle("Tabla Consulta");
		setClosable(true);
		...
		JLabel lblTitulo = new JLabel("Datos de la Consulta");
		pnlTitulo.add(lblTitulo);

		tblConsulta = new JTable();
		tblConsulta.setModel(new ModelConsulta());

		JScrollPane scrollPaneTabla = new JScrollPane(tblConsulta);
	...
	public void cargarDatos() {
		tblConsulta.setModel(new ModelConsulta(gp.getConsultas()));
	}
